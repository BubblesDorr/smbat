...
ErrorType
BehaviorPlannerMapAdapter::GetChildLaneIds(const int lane_id,
...
ErrorType
BehaviorPlannerMapAdapter::GetFatherLaneIds(const int lane_id,
...
ErrorType
BehaviorPlannerMapAdapter::GetKeyVehicles(common::VehicleSet* key_vehicle_set) {
    if (!is_valid_)
        return kWrongStatus;
...
ErrorType
BehaviorPlannerMapAdapter::GetWholeLaneNet(common::LaneNet* lane_net) {
    if (!is_valid_)
        return kWrongStatus;
