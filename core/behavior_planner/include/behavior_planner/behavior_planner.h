#ifndef _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_BEHAVIOR_PLANNER_H_
#define _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_BEHAVIOR_PLANNER_H_
...
class BehaviorPlanner : public Planner {
  ...
  protected:
    ...
    ErrorType ConstructLaneFromSamples(const vec_E<Vecf<2>>& samples,
                                       Lane* lane);
    ...
    ErrorType
    GetDesiredVelocityOfTrajectory(const vec_E<common::Vehicle> vehicle_vec,
                                   decimal_t* vel);
...
#endif // _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_BEHAVIOR_PLANNER_H_