#ifndef _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_VISUALIZER_H_
#define _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_VISUALIZER_H_
...
class BehaviorPlannerVisualizer {
  public:
    ...
    void Init() {
        ...
        forward_traj_vis_pub_ = nh_.advertise<visualization_msgs::MarkerArray>(
            forward_traj_topic, 1);
    }
...
#endif // _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_VISUALIZER_H_