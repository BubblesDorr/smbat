#ifndef _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_MAP_ADAPTER_H_
#define _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_MAP_ADAPTER_H_
...
class BehaviorPlannerMapAdapter : public BehaviorPlannerMapItf {
  public:
    ...
    GetPredictedBehavior(const int vehicle_id,
                         common::LateralBehavior* lat_behavior) override;
...
#endif // _CORE_BEHAVIOR_PLANNER_INCLUDE_BEHAVIOR_PLANNER_MAP_ADAPTER_H_