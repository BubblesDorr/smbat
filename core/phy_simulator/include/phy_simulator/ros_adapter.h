#ifndef _CORE_PHY_SIMULATOR_INCLUDE_PHY_SIMULATOR_ROS_ADAPTER_H_
#define _CORE_PHY_SIMULATOR_INCLUDE_PHY_SIMULATOR_ROS_ADAPTER_H_
...
#endif // _CORE_PHY_SIMULATOR_INCLUDE_PHY_SIMULATOR_ROS_ADAPTER_H_