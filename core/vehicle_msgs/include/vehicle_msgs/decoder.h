#ifndef _CORE_VEHICLE_MSGS_INCLUDE_DECODER_H_
#define _CORE_VEHICLE_MSGS_INCLUDE_DECODER_H_
...
class Decoder {
  public:
    static ErrorType
    GetFreeStateMsgFromRosFreeState(const vehicle_msgs::FreeState& in_state,
    ...
    static ErrorType
    GetStateFromRosStateMsg(const vehicle_msgs::State& in_state,
                            common::State* state) {
        state->time_stamp = in_state.header.stamp.toSec();
    ...
    static ErrorType
    GetVehicleSetFromRosVehicleSet(const vehicle_msgs::VehicleSet& msg,
    ...
    static ErrorType
    GetVehicleParamFromRosVehicleParam(const vehicle_msgs::VehicleParam& msg,
    ...
    static ErrorType
    GetObstacleSetFromRosObstacleSet(const vehicle_msgs::ObstacleSet& msg,
    ...
    static ErrorType GetCircleObstacleFromRosCircleObstacle(
        const vehicle_msgs::CircleObstacle& msg,
    ...
    static ErrorType GetPolygonObstacleFromRosPolygonObstacle(
        const vehicle_msgs::PolygonObstacle& msg,
    ...
    static ErrorType
    GetControlSignalFromRosControlSignal(const vehicle_msgs::ControlSignal& msg,
...
#endif // _CORE_VEHICLE_MSGS_INCLUDE_DECODER_H_