#ifndef _CORE_ROUTE_PLANNER_INCLUDE_ROUTE_PLANNER_ROUTE_PLANNER_H_
#define _CORE_ROUTE_PLANNER_INCLUDE_ROUTE_PLANNER_ROUTE_PLANNER_H_
...
#endif // _CORE_ROUTE_PLANNER_INCLUDE_ROUTE_PLANNER_ROUTE_PLANNER_H_