...
IdealSteerModel::IdealSteerModel(double wheelbase_len, double max_lon_acc,
    ...
    : wheelbase_len_(wheelbase_len), max_lon_acc_(max_lon_acc),
      max_lon_dec_(max_lon_dec), max_lon_acc_jerk_(max_lon_acc_jerk),
      max_lon_dec_jerk_(max_lon_dec_jerk), max_lat_acc_(max_lat_acc),
      max_lat_jerk_(max_lat_jerk), max_steering_angle_(max_steering_angle),
      max_steer_rate_(max_steer_rate), max_curvature_(max_curvature) {
...
void IdealSteerModel::TruncateControl(const decimal_t& dt) {
    ...
    //     sqrt(max_lat_acc_ / std::min(fabs(state_.curvature),
    //     max_curvature_));
    // control_.velocity =
    //     std::min(std::max(0.0, control_.velocity),
    //     max_velocity_by_model);
    ...
    lat_jerk_desired =
        truncate(lat_jerk_desired, -max_lat_jerk_, max_lat_jerk_);
