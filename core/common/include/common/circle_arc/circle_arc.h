#ifndef _CORE_COMMON_INCLUDE_COMMON_CIRCLE_ARC_CIRCLE_ARC_H_
#define _CORE_COMMON_INCLUDE_COMMON_CIRCLE_ARC_CIRCLE_ARC_H_
...
class CircleArc {
  public:
    ...
    // inline std::vector<Vec3f> sampled_states() const { return
    // sampled_states_;
    // }
...
#endif // _CORE_COMMON_INCLUDE_COMMON_CIRCLE_ARC_CIRCLE_ARC_H_