#ifndef _CORE_COMMON_INCLUDE_COMMON_CIRCLE_ARC_CIRCLE_ARC_BRANCH_H_
#define _CORE_COMMON_INCLUDE_COMMON_CIRCLE_ARC_CIRCLE_ARC_BRANCH_H_
...
class CircleArcBranch {
  public:
    ...
    CircleArcBranch(const Vec3f& start_state,
        ...
        : start_state_(start_state), curvature_vec_(curvature_vec),
...
#endif // _CORE_COMMON_INCLUDE_COMMON_CIRCLE_ARC_CIRCLE_ARC_BRANCH_H_