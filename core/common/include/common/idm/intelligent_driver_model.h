#ifndef _CORE_COMMON_INCLUDE_COMMON_IDM_INTELLIGENT_DRIVER_MODEL_H_
#define _CORE_COMMON_INCLUDE_COMMON_IDM_INTELLIGENT_DRIVER_MODEL_H_
...
class IntelligentDriverModel {
  public:
    struct State {
        ...
        State() {}
        State(const decimal_t& s_, const decimal_t& v_,
              const decimal_t& s_front_, const decimal_t& v_front_)
...
#endif // _CORE_COMMON_INCLUDE_COMMON_IDM_INTELLIGENT_DRIVER_MODEL_H_