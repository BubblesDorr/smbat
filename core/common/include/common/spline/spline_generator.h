#ifndef _CORE_COMMON_INCLUDE_COMMON_SPLINE_SPLINE_GENERATOR_H_
#define _CORE_COMMON_INCLUDE_COMMON_SPLINE_SPLINE_GENERATOR_H_
...
template <int N_DEG, int N_DIM> class SplineGenerator {
  public:
     ...
     */
    static ErrorType
    GetCubicSplineBySampleInterpolation(const vec_Vecf<N_DIM>& samples,
     ...
     */
    static ErrorType
    GetWaypointsFromPositionSamples(const vec_Vecf<N_DIM>& samples,
                                    const std::vector<decimal_t>& para,
     ...
     */
    static ErrorType
    GetSplineFromFreeStateVec(const std::vector<decimal_t>& para,
...
#endif // _CORE_COMMON_INCLUDE_COMMON_SPLINE_SPLINE_GENERATOR_H_