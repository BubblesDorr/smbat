#ifndef _CORE_COMMON_INCLUDE_COMMON_SPLINE_SPLINE_H_
#define _CORE_COMMON_INCLUDE_COMMON_SPLINE_SPLINE_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_SPLINE_SPLINE_H_