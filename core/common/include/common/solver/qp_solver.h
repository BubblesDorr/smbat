#ifndef _CORE_COMMON_INCLUDE_COMMON_SOLVER_QP_SOLVER_H_
#define _CORE_COMMON_INCLUDE_COMMON_SOLVER_QP_SOLVER_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_SOLVER_QP_SOLVER_H_