#ifndef _CORE_COMMON_INCLUDE_COMMON_SOLVER_OOQP_INTERFACE_H_
#define _CORE_COMMON_INCLUDE_COMMON_SOLVER_OOQP_INTERFACE_H_
...
class OoQpItf {
  ...
  private:
     ...
     */
    static void
    generateLimits(const Eigen::VectorXd& l, const Eigen::VectorXd& u,
    ...
    static void
    printLimits(const Eigen::Matrix<char, Eigen::Dynamic, 1>& useLowerLimit,
...
#endif // _CORE_COMMON_INCLUDE_COMMON_SOLVER_OOQP_INTERFACE_H_