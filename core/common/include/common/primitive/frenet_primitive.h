#ifndef _CORE_COMMON_INCLUDE_COMMON_PRIMITIVE_FRENET_PRIMITIVE_H_
#define _CORE_COMMON_INCLUDE_COMMON_PRIMITIVE_FRENET_PRIMITIVE_H_
...
class FrenetPrimitive {
  public:
    ...
    ErrorType GetFrenetStateSamples(const decimal_t step,
                                    const decimal_t offset,
...
#endif // _CORE_COMMON_INCLUDE_COMMON_PRIMITIVE_FRENET_PRIMITIVE_H_