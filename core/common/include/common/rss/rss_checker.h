#ifndef _CORE_COMMON_INCLUDE_COMMON_RSS_RSS_CHECKER_H_
#define _CORE_COMMON_INCLUDE_COMMON_RSS_RSS_CHECKER_H_
  ...
  public:
    ...
    struct RssConfig {
        ...
        RssConfig(const decimal_t _response_time,
                  ...
                  const decimal_t _lateral_brake_max,
                  const decimal_t _lateral_miu)
            : response_time(_response_time),
              ...
              lateral_brake_max(_lateral_brake_max), lateral_miu(_lateral_miu) {
        }
    };
    ...
    static ErrorType
    CalculateSafeLateralDistance(const decimal_t ego_vel,
                                 const decimal_t other_vel,
                                 const LateralDirection& direction,
                                 const RssConfig& config, decimal_t* distance);

    static ErrorType
    CalculateRssSafeDistances(const std::vector<decimal_t>& ego_vels,
                              const std::vector<decimal_t>& other_vels,
                              const LongitudinalDirection& long_direct,
                              const LateralDirection& lat_direct,
...
#endif // _CORE_COMMON_INCLUDE_COMMON_RSS_RSS_CHECKER_H_