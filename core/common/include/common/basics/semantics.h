#ifndef _CORE_COMMON_INCLUDE_COMMON_BASICS_SEMANTICS_H_
#define _CORE_COMMON_INCLUDE_COMMON_BASICS_SEMANTICS_H_
 ...
 */
template <typename T, int N_DIM> class GridMapND {
  public:
    enum ValType {
        OCCUPIED = 70,
        // FREE = 102,
    ...
    inline void
    set_dims_resolution(const std::array<decimal_t, N_DIM>& dims_resolution) {
     ...
     */
    ErrorType
    GetValueUsingGlobalPosition(const std::array<decimal_t, N_DIM>& p_w,
                                T* val) const;
     ...
     */
    ErrorType
    CheckIfEqualUsingGlobalPosition(const std::array<decimal_t, N_DIM>& p_w,
     ...
     */
    ErrorType
    SetValueUsingGlobalPosition(const std::array<decimal_t, N_DIM>& p_w,
                                const T& val);
     ...
     */
    std::array<int, N_DIM>
    GetCoordUsingGlobalPosition(const std::array<decimal_t, N_DIM>& p_w) const;
     ...
     */
    ErrorType
    GetGlobalPositionUsingCoordinate(const std::array<int, N_DIM>& coord,
...
template <int N_DIM> struct SpatioTemporalSemanticCubeNd {
    decimal_t t_lb, t_ub;
...
#endif // _CORE_COMMON_INCLUDE_COMMON_BASICS_SEMANTICS_H_