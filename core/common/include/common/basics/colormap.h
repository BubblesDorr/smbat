#ifndef _CORE_COMMON_INCLUDE_COMMON_BASICS_COLORMAP_H_
#define _CORE_COMMON_INCLUDE_COMMON_BASICS_COLORMAP_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_BASICS_COLORMAP_H_