#ifndef _CORE_COMMON_INCLUDE_COMMON_BASICS_TOOL_FUNC_H_
#define _CORE_COMMON_INCLUDE_COMMON_BASICS_TOOL_FUNC_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_BASICS_TOOL_FUNC_H_