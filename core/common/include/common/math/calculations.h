#ifndef _CORE_COMMON_INCLUDE_COMMON_MATH_CALCULATIONS_H_
#define _CORE_COMMON_INCLUDE_COMMON_MATH_CALCULATIONS_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_MATH_CALCULATIONS_H_