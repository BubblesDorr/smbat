 ...
 */
#ifndef _CORE_COMMON_INCLUDE_COMMON_MATH_POLY_ROOTS_H_
#define _CORE_COMMON_INCLUDE_COMMON_MATH_POLY_ROOTS_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_MATH_POLY_ROOTS_H_