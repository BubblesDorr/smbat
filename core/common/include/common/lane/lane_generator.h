#ifndef _CORE_COMMON_INCLUDE_COMMON_LANE_LANE_GENERATOR_H_
#define _CORE_COMMON_INCLUDE_COMMON_LANE_LANE_GENERATOR_H_
...
class LaneGenerator {
  public:
    static ErrorType
    GetLaneBySampleInterpolation(const vec_Vecf<LaneDim>& samples,
...
#endif // _CORE_COMMON_INCLUDE_COMMON_LANE_LANE_GENERATOR_H_