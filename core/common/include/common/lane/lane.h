#ifndef _CORE_COMMON_INCLUDE_COMMON_LANE_LANE_H_
#define _CORE_COMMON_INCLUDE_COMMON_LANE_LANE_H_
...
class Lane {
  public:
    ...
    ErrorType
    GetArcLengthByVecPositionWithInitialGuess(const Vecf<LaneDim>& vec_position,
...
#endif // _CORE_COMMON_INCLUDE_COMMON_LANE_LANE_H_