#ifndef _CORE_COMMON_INCLUDE_COMMON_STATE_FREE_STATE_H_
#define _CORE_COMMON_INCLUDE_COMMON_STATE_FREE_STATE_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_STATE_FREE_STATE_H_