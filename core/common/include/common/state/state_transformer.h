#ifndef _CORE_COMMON_INCLUDE_COMMON_STATE_STATE_TRANSFORMER_H_
#define _CORE_COMMON_INCLUDE_COMMON_STATE_STATE_TRANSFORMER_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_STATE_STATE_TRANSFORMER_H_