#ifndef _CORE_COMMON_INCLUDE_COMMON_TRAJECTORY_FRENET_TRAJ_H_
#define _CORE_COMMON_INCLUDE_COMMON_TRAJECTORY_FRENET_TRAJ_H_
...
#endif // _CORE_COMMON_INCLUDE_COMMON_TRAJECTORY_FRENET_TRAJ_H_