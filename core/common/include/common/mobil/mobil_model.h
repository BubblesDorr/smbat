#ifndef _CORE_COMMON_INCLUDE_COMMON_MOBIL_MOBIL_MODEL_H_
#define _CORE_COMMON_INCLUDE_COMMON_MOBIL_MOBIL_MODEL_H_
...
class MobilLaneChangingModel {
  public:
    static ErrorType GetMobilAccChangesOnCurrentLane(
        ...
        const FrenetState& following_fs, decimal_t* acc_o,
        decimal_t* acc_o_tilda, decimal_t* acc_c);
...
#endif // _CORE_COMMON_INCLUDE_COMMON_MOBIL_MOBIL_MODEL_H_