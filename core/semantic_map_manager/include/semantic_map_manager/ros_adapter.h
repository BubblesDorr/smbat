#ifndef _CORE_SEMANTIC_MAP_MANAGER_INCLUDE_SEMANTIC_MAP_MANAGER_ROS_ADAPTER_H_
#define _CORE_SEMANTIC_MAP_MANAGER_INCLUDE_SEMANTIC_MAP_MANAGER_ROS_ADAPTER_H_
...
class RosAdapter {
  public:
    ...
    void
    BindMapUpdateCallback(std::function<int(const SemanticMapManager&)> fn);
  ...
  private:
    ...
    void
    ArenaInfoStaticCallback(const vehicle_msgs::ArenaInfoStatic::ConstPtr& msg);
...
#endif // _CORE_SEMANTIC_MAP_MANAGER_INCLUDE_SEMANTIC_MAP_MANAGER_ROS_ADAPTER_H_