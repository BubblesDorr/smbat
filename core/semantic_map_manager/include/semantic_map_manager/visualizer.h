#ifndef _CORE_SEMANTIC_MAP_MANAGER_INCLUDE_SEMANTIC_MAP_MANAGER_VISUALIZER_H_
#define _CORE_SEMANTIC_MAP_MANAGER_INCLUDE_SEMANTIC_MAP_MANAGER_VISUALIZER_H_
...
class Visualizer {
  public:
    ...
    void
    VisualizeDataWithStampForPlayback(const ros::Time& stamp,
                                      const SemanticMapManager& smm,
  ...
  private:
    ...
    void VisualizeOpenloopTrajPrediction(
        const ros::Time& stamp,
        const std::unordered_map<int, vec_E<common::State>>&
            openloop_pred_trajs);
...
#endif // _CORE_SEMANTIC_MAP_MANAGER_INCLUDE_SEMANTIC_MAP_MANAGER_VISUALIZER_H_