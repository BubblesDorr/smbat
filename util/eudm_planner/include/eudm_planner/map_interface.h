#ifndef _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_MAP_INTERFACE_H_
#define _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_MAP_INTERFACE_H_
...
class EudmPlannerMapItf {
  public:
    ...
    virtual ErrorType IsTopologicallyReachable(const int lane_id,
                                               ...
                                               bool* res) = 0;
    virtual bool IsLaneConsistent(const int lane_id_old,
                                  const int lane_id_new) = 0;
    virtual ErrorType GetKeyVehicles(common::VehicleSet* key_vehicle_set) = 0;
    virtual ErrorType
    GetSurroundingVehicles(common::VehicleSet* key_vehicle_set) = 0;
    virtual ErrorType
...
#endif // _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_MAP_INTERFACE_H_