#ifndef _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_MAP_ADAPTER_H_
#define _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_MAP_ADAPTER_H_
...
class EudmPlannerMapAdapter : public EudmPlannerMapItf {
  public:
    ...
    ErrorType IsTopologicallyReachable(const int lane_id,
                                       ...
                                       bool* res) override;
    bool IsLaneConsistent(const int lane_id_old,
                          const int lane_id_new) override;
    ...
    ErrorType
    GetSurroundingVehicles(common::VehicleSet* key_vehicle_set) override;
...
#endif // _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_MAP_ADAPTER_H_