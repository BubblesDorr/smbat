#ifndef _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_DCP_TREE_H_
#define _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_DCP_TREE_H_
...
class DcpTree {
    ...
    struct DcpAction {
        ...
        friend std::ostream& operator<<(std::ostream& os,
            ...
            os << "(lon: " << static_cast<int>(action.lon)
               << ", lat: " << static_cast<int>(action.lat)
               << ", t: " << action.t << ")";
            return os;
        }
  ...
  private:
    ...
    std::vector<DcpAction>
    AppendActionSequence(const std::vector<DcpAction>& seq_in,
                         const DcpAction& a, const int& n) const;
...
#endif // _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_DCP_TREE_H_