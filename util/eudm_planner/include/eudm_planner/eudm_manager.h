#ifndef _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_EUDM_MANAGER_H_
#define _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_EUDM_MANAGER_H_
...
class EudmManager {
  public:
    ...
    ErrorType
    Run(const decimal_t stamp,
        const std::shared_ptr<semantic_map_manager::SemanticMapManager>&
            map_ptr,
    ...
    int processed_winner_id() const {
        return last_snapshot_.processed_winner_id;
    }
...
#endif // _UTIL_EUDM_PLANNER_INCLUDE_EUDM_PLANNER_EUDM_MANAGER_H_