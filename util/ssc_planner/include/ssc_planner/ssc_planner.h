#ifndef _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_SSC_PLANNER_H_
#define _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_SSC_PLANNER_H_
...
class SscPlanner : public Planner {
  public:
    ...
    std::unordered_map<int, vec_E<common::FsVehicle>>
    sur_vehicle_trajs_fs() const {
...
#endif // _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_SSC_PLANNER_H_