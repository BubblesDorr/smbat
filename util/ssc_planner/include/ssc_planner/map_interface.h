#ifndef _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_MAP_INTERFACE_H_
#define _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_MAP_INTERFACE_H_
...
class SscPlannerMapItf {
  public:
    ...
    virtual ErrorType
    GetObstacleGrids(std::set<std::array<decimal_t, 2>>* obs_grids) = 0;
};

} // namespace planning

#endif // _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_MAP_INTERFACE_H_