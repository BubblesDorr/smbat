#ifndef _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_SSC_MAP_H_
#define _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_SSC_MAP_H_
...
class SscMap {
  public:
    ...
    ErrorType
    ConstructSscMap(const std::unordered_map<int, vec_E<common::FsVehicle>>&
  ...
  private:
    ...
    bool
    CheckIfPlaneIsFreeOnXAxis(GridMap3D* p_grid,
                              const common::AxisAlignedCubeNd<int, 3>& cube,
                              const int& z) const;

    bool
    CheckIfPlaneIsFreeOnYAxis(GridMap3D* p_grid,
                              const common::AxisAlignedCubeNd<int, 3>& cube,
                              const int& z) const;

    bool
    CheckIfPlaneIsFreeOnZAxis(GridMap3D* p_grid,
                              const common::AxisAlignedCubeNd<int, 3>& cube,
                              const int& z) const;

    bool
    CheckIfCubeContainsSeed(const common::AxisAlignedCubeNd<int, 3>& cube_a,
                            const Vec3i& seed) const;

    ErrorType
    GetInitialCubeUsingSeed(const Vec3i& seed_0, const Vec3i& seed_1,
    ...
    ErrorType
    FillDynamicPart(const std::unordered_map<int, vec_E<common::FsVehicle>>&
                        sur_vehicle_trajs_fs);
...
#endif // _UTIL_SSC_PLANNER_INCLUDE_SSC_PLANNER_SSC_MAP_H_